...
var ISO8601Helper_1 = require("../main/ISO8601Helper");
describe('ISO8601Helper', function () {
    it('dayOfWeek', function () {
        var date, result;
        date = new Date(2018, 10, 1);
        result = ISO8601Helper_1.ISO8601Helper.dayOfWeek(date);
    ...
    it('dayOfWeekInMonth', function () {
        var date, result;
        date = new Date(2018, 10, 1);
        result = ISO8601Helper_1.ISO8601Helper.dayOfWeekInMonth(date);
    ...
    it('dayOfYear', function () {
        ...
        result = ISO8601Helper_1.ISO8601Helper.dayOfYear(date);
        expect(result).toBe(3);
    ...
    it('weekBasedYear', function () {
        ...
        result = ISO8601Helper_1.ISO8601Helper.weekBasedYear(date);
    ...
    it('weekOfMonth', function () {
        var date, result;
        date = new Date(2018, 10, 1);
        result = ISO8601Helper_1.ISO8601Helper.weekOfMonth(date);
        expect(result).toBe(1);
    ...
    it('weekOfYear', function () {
        var date, result;
        date = new Date(2018, 0, 1);
        result = ISO8601Helper_1.ISO8601Helper.weekOfYear(date);
        expect(result).toBe(1);
...
//# sourceMappingURL=ISO8601HelperSpec.js.map